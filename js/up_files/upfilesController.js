...
//Funcion para determinar campos vacios
...
//Fu8ncion para cargar el archivo desde el boton browse o examinar
...
function guardar(){
	...
	if(isVacio(archivo) || isVacio(codigoArchivo) || isVacio(areaArchivo) || isVacio(archivo) || isVacio(version) || isVacio(fichero)){
		...
		toastr.error(`Todos los campos deben estar diligenciados`, '¡Recuerda!');
